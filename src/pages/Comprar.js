...
export default function Busca() {
  ...
  useEffect(() => {
    async function loadProducts() {
      ...
      let filtered = product.filter(el => el["option"] === "comprar");
    ...
    <div>
      <nav>
        ...
        <div className="desc">
          <h1>Comprar</h1>
          <p>
            Este são os imóveis disponíveis para comprar. Utilize nossa página
            de <Link to="/busca">busca</Link> para aceesar mais informações
            sobre os imóveis.
          </p>
        </div>
      </nav>
